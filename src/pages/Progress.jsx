...
function TeenProgress({ profile, partner }) {
  ...
  const handleDownloadImpact = () => {
    ...
    win.document.write(`
      ...
      <html>
      <head>
        <title>GenBridge Impact Summary — ${profile.name}</title>
        <style>
      ...
      <body>
        ...
        <div class="footer">
          Generated by GenBridge &bull; A program of GenLink, 501(c)(3) &bull; Austin, TX<br/>
